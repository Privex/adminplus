...
project = 'Privex Django Admin Plus'
...
htmlhelp_basename = 'PrivexAdminPlusDoc'
...
latex_documents = [
    (master_doc, 'PrivexAdminPlus.tex', 'Privex Django AdminPlus Documentation',
...
man_pages = [
    (master_doc, 'privexadminplus', 'Privex Django AdminPlus Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PrivexAdminPlus', 'Privex Python Django AdminPlus Documentation',
     author, 'PrivexAdminPlus', 'Privex Python Django AdminPlus.',
     'Miscellaneous'),
]
